...
value_transformer_pipeline = ValueTransformerPipeline(
    input_value=energy_bass_detector.kick_energy_ratio,
    input_value_interval=[0, 1],
    output_value_interval=[2, 100],
    power=3
)

gradient_rainbow = GradiantRainbow(
    inv_fraction=5,
    roll_speed=value_transformer_pipeline.output_value
)
